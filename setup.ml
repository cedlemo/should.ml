...
(* OASIS_START *)
(* DO NOT EDIT (digest: e7aa99732e783093d4e7535fd7e00601) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$unit_tests", []))];
     ...
     package =
       {
          ...
          authors = ["Mike Lin"];
          homepage = Some "https://github.com/mlin/should.ml";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Write assertions in in (roughly) plain English"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "unit_tests.ml"});
               Test
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "unit_tests"]
                   })
            ];
     ...
     oasis_digest = Some "k\0012\180\191Q\214LI\133)s\200!\188\021";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
